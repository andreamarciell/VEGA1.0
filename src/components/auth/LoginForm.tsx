...
export const LoginForm = ({
  ...
  return <Card className="w-full max-w-md mx-auto shadow-lg">
      ...
      <CardContent className="space-y-6">
        {error && <Alert variant={isHighAttempts ? "destructive" : "default"}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          }))} placeholder="Enter your username" disabled={isLoading} className={error ? "border-destructive focus-visible:ring-destructive" : ""} autoComplete="username" required />
          </div>
          ...
          <div className="space-y-2">
            ...
            <PasswordInput value={credentials.password} onChange={value => setCredentials(prev => ({
            ...prev,
            password: value
          }))} placeholder="Enter your password" disabled={isLoading} error={!!error} />
          </div>
